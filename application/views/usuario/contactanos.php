...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href=" <?php echo base_url(). 'acceso/img/fav.png';?>"
	<!-- Author Meta -->
    ...
    <link rel="stylesheet" href="<?php echo base_url(). 'acceso/css/styles.css'; ?>" />
	<!--
            CSS
            ============================================= -->
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item"><a class="nav-link" href="<?php echo base_url().'tienda';?> ">Home</a></li>
				...
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget mail-chimp">
						...
						<ul class="instafeed d-flex flex-wrap">
							<li><img src="<?php echo base_url().'acceso/img/i1.jpg';?>" alt=""></li>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="<?php echo base_url(). 'acceso/js/vendor/bootstrap.min.js';?>" ></script>
	<script src="<?php echo base_url(). 'acceso/js/jquery.ajaxchimp.min.js';?>" ></script>
	...
	<script src="<?php echo base_url(). 'acceso/js/nouislider.min.js'; ?>"></script>
	<script src=" "<?php echo base_url(). 'acceso/js/jquery.magnific-popup.min.js';?>"></script>
	<script src="<?php echo base_url(). 'acceso/js/owl.carousel.min.js'; ?>"></script>
	<!--gmaps Js-->
