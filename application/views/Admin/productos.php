                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row mt-3 justify-content-center">
                                        <div class="col-auto">
                                        <a class="btn btn-outline-success" href="registrarp" role="button">Registrar Productos</a>
                                        </div>
                                   </div>
                  ...
                  <?php    if(isset($productos)): ?>
                    <?php foreach ($productos as $usuario): ?>
                  ...
                  <tr>
                    ...
                    <td> 
                        <a class="btn btn-danger" href="<?php echo base_url().'gestionar-articulo/eliminar?producto='.@$usuario->producto; ?>">Eliminar</a> 
                </td>
                <td><a class="btn btn-primary" href="<?php echo base_url().'buscando/'.@$usuario->_id; ?>">Editar</a>
               </td>
